...
*/
public class FormFieldListWidget extends A_CmsWidget {
    ...
    */
    public FormFieldListWidget(String configuration) {
        super(configuration);
    }
    ...
    public String getDialogWidget(CmsObject cms, I_CmsWidgetDialog widgetDialog, I_CmsWidgetParameter param) {
        ...
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(uri)) {
            ...
            try {
                ...
                if (iInputs.hasNext()) {
                    result.append("<table cellspacing=\"2\" cellpadding=\"2\" border=\"0\">");
                    result.append("<tbody>");
                    while (iInputs.hasNext()) {
                        ...
                        result.append("<tr" + (checkedFields.contains(name) ? " style=\"font-weight:bold;\"" : "") + ">"
                                        + "<td>" + CmsEncoder.escapeXml(label) + "</td>"
                                        + "<td><span style=\"font-family:courier, monospace;\">" + CmsEncoder.escapeXml(name) + "</span></td>"
                                    + "</tr>");
    ...
    */
    ...
    public I_CmsWidget newInstance() {
        return new FormFieldListWidget(getConfiguration());
    }
